...
export default function Character() {
  ...
  // Subscribe to keyboard events for logging
  useEffect(() => {
    const unsubscribe = subscribe(
      ...
      (keys) => {
        ...
        if (forward || backward || leftward || rightward) {
          console.log('Movement keys:', { forward, backward, leftward, rightward });
        }
      }
    );
    return unsubscribe;
  ...
  useFrame(() => {
    ...
    characterRef.current.position.set(newPosition.x, newPosition.y, newPosition.z);
  });
